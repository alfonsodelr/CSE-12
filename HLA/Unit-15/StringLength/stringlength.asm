...
ExceptionPtr__hla_	equ	fs:0
		...
		include	'stringlength.extpub.inc'




		section	'.data' data readable writeable align 16
		include	'stringlength.data.inc'

		dd	0	;dummy to keep linker happy
		section	'.bss' readable writeable align 16
		include	'stringlength.bss.inc'

		rb	4	;dummy to keep linker happy
		section	'.text' code readable executable align 16
		include	'stringlength.consts.inc'

		include	'stringlength.ro.inc'
...
L826_strlen__hla_:
		mov	dword ptr [L828_EBXRegister__hla_+0], ebx	;/* EBXRegister */
		mov	word ptr [L829_DXRegister__hla_+0], dx	;/* DXRegister */
		pop	dword ptr [L827_iReturnAddress__hla_+0]	;/* iReturnAddress */
		pop	ebx
		push	dword ptr [L827_iReturnAddress__hla_+0]	;/* iReturnAddress */
		push	dword ptr [L828_EBXRegister__hla_+0]	;/* EBXRegister */
		push	word ptr [L829_DXRegister__hla_+0]	;/* DXRegister */
		mov	dx, 0

L831_Loop_Count__hla_:
		cmp	[ebx+0], dh	;/* [ebx] */
		je	L832_End_Count__hla_
		inc	ebx
		inc	byte ptr [L830_count__hla_+0]	;/* count */
		jmp	L831_Loop_Count__hla_

L832_End_Count__hla_:
		mov	al, byte ptr [L830_count__hla_+0]	;/* count */
		pop	dx
		pop	ebx
		ret
xL826_strlen__hla___hla_:
;L826_strlen__hla_ endp
...
;/* for this program. */
		...
		mov	eax, L847_stringData__hla_
		push	eax
		push	word ptr [L824_stringDataLen__hla_+0]	;/* stringDataLen */
		call	L806_gets__hla_
		mov	eax, L848_stringData__hla_
		push	eax
		call	L826_strlen__hla_
		mov	byte ptr [L825_main_count__hla_+0], al	;/* main_count */
		push	L862_str__hla_
		call	STDOUT_PUTS	; puts
		mov	eax, L863_stringData__hla_
		push	eax
		...
		push	dword 00h
		push	eax
		mov	al, byte ptr [L825_main_count__hla_+0]	; main_count
		mov	byte ptr [ESP+4], al
		pop	eax
