...
L830_starting__hla_:
		cmp	[ebx+0], dh	;/* [ebx] */
		je	L831_outloop__hla_
		mov	dl, [ebx+0]	;/* [ebx] */
		cmp	dl, 48
		jne	L832_nextcheck__hla_
		inc	dword ptr [L829_zeros__hla_+0]	;/* zeros */

L832_nextcheck__hla_:
		cmp	dl, 49
		jne	L833_endingloop__hla_
		inc	byte ptr [L828_ones__hla_+0]	;/* ones */

L833_endingloop__hla_:
		inc	ebx
		jmp	L830_starting__hla_

L831_outloop__hla_:
		mov	eax, dword ptr [L829_zeros__hla_+0]	;/* zeros */
		cmp	dword ptr [L829_zeros__hla_+0], 0	;/* zeros */
		jne	L834_checkone__hla_
		jmp	L835_exitprotwo__hla_

L834_checkone__hla_:
		cmp	byte ptr [L828_ones__hla_+0], 0	;/* ones */
		jne	L836_exitproone__hla_
		jmp	L835_exitprotwo__hla_

L836_exitproone__hla_:
		mov	eax, 1
		jmp	L837_exitpro__hla_

L835_exitprotwo__hla_:
		mov	eax, 0
		jmp	L837_exitpro__hla_
...
L837_exitpro__hla_:
		...
		pop	ebx
		ret
xL824_has1sand0s__hla___hla_:
;L824_has1sand0s__hla_ endp
